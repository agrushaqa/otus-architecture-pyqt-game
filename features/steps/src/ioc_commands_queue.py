...
from features.steps.src.ioc_working_thread import thread_local
from features.steps.src.queue.exception_handler import exception_handler


class IocCommandQueue:
    def __init__(self):
        self._running = True
        thread_local._soft_stop = False
    ...
    def ioc_register_queue(self):
        try:
            ...
            if ioc_reg_cmd is not None:
                ...
                self.ioc.resolve(key="IoC.register",
    ...
    def ioc_execution_queue(self):
        try:
            ...
            if ioc_cmd is not None:
                self.ioc.resolve(ioc_cmd['command'],
                                 *ioc_cmd['argv'],
